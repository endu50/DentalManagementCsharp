...
<!doctype html>
 ...
 <asp:Repeater ID="Repeater11" runat="server" EnableVIewState="true" OnItemCommand="Repeater1_ItemCommand"   >
    <HeaderTemplate>
        <table>
            <tr>
                                      <td><b>Search</b><asp:TextBox ID="search" runat="server" placeholder="Enter Phonenumber" ></asp:TextBox></td>
                                     <td><asp:LinkButton ID="LinkButton2" Text="Search" CausesValidation="false" runat="server" OnClick="OnSearch" EnableVIewState="true" class="btn btn-success btn-sm" /></td>
...
<asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
        ...
        <div style="margin-top: 20px;">
                    <table style="width: 600px;">
                        <tr>
                            <td>
                                <asp:LinkButton ID="lbFirst1" runat="server" OnClick="lbFirst_Click" class="btn btn-success btn-sm"  BorderColor="YellowGreen">First</asp:LinkButton>
                            </td>
                            <td>
                                <asp:LinkButton ID="lbPrevious1" runat="server" OnClick="lbPrevious_Click" class="btn btn-success btn-sm" BorderColor="YellowGreen">Previous</asp:LinkButton>
                            </td>
                            <td>
