        ...
        <div class="container">
            <div class="row">
                ...
                <div style="padding:20px" class="col-sm-7">
                   ...
                   <b>Enter Phone Number:</b> <asp:TextBox ID="searchbox" runat="server" BorderStyle="Dotted"  text-align="center" placeholder="enter phonenumber"   Visible="True" BackColor="WhiteSmoke"></asp:TextBox>  
                   
                    <asp:Button ID="search" runat="server" BorderStyle="Double"  OnClick="search_Click" text-align="center" CausesValidation="false" Text="Search" Visible="True" BackColor="Lime"></asp:Button>  <br></div>
                    ...
                    <div class="row cont-row">
                      ...
                      <div class="col-sm-8"> <asp:TextBox ID="TextBox4" runat="server"  ReadOnly="true" border-radius="50px 0px 0px 50px"  placeholder="Enter The Gender" class="form-control input-sm" Width="368px"></asp:TextBox>
                    <asp:DropDownList ID="gender" runat="server" border-radius="0px 50px 50px 0px" AutoPostBack = "true" OnSelectedIndexChanged = "gender_SelectedIndexChanged" Height="32px" Width="154px">
    <asp:ListItem Text="Select Gender" Value="1" />
        <asp:ListItem Text="Male" Value="2" />
    <asp:ListItem Text="Female" Value="3" />
</asp:DropDownList>
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="TextBox4" ErrorMessage="p/s enter The Gender" BackColor="#FFCCFF"></asp:RequiredFieldValidator>
                            
                       </div>
                                 </div>
                                            
             <div  class="row cont-row">
                        <div  class="col-sm-3"><label>Age:</label><span></span></div>
                       <div class="col-sm-8"><asp:TextBox ID="TextBox5" runat="server"  TextMode="Number"  placeholder="Enter Age" class="form-control input-sm"></asp:TextBox>
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="TextBox2" ErrorMessage="p/s enter Age" BackColor="#FFCCFF"></asp:RequiredFieldValidator>
                             </div>
                        </div>
                           <div  class="row cont-row">
                        <div  class="col-sm-3"><label>Price:</label><span></span></div>
                       <div class="col-sm-8"><asp:TextBox ID="TextBox6" runat="server"  TextMode="Number" placeholder="Enter The Price" class="form-control input-sm"></asp:TextBox>
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="TextBox2" ErrorMessage="p/s enter The Price" BackColor="#FFCCFF"></asp:RequiredFieldValidator>
                             </div>
                        </div>
                            <div  class="row cont-row">
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox2" ErrorMessage="p/s enter your Mobile number" BackColor="#FFCCFF"></asp:RequiredFieldValidator>
                    ...
                    <div  class="row cont-row">
                       ...
                       <div class="col-sm-8"> <asp:TextBox ID="TextBox3" runat="server"  placeholder="Enter Email Address" class="form-control input-sm"></asp:TextBox>   
                            ...
                            <div  class="row cont-row">
            <div  class="col-sm-3"><label>DateTime:</label><span></span></div>
           <div class="col-sm-8"> <asp:TextBox ID="TextBox7" runat="server"  TextMode="DateTime" placeholder="CurrentDate" class="form-control input-sm"></asp:TextBox>   
               </div>
        </div>
         <div  class="row cont-row">
            <div  class="col-sm-3"><label>RegisterdBy:</label><span></span></div>
           <div class="col-sm-8"> <asp:TextBox ID="TextBox8" runat="server"  ReadOnly="true" class="form-control input-sm"></asp:TextBox>   
               </div>
        </div>
                    <div  class="row cont-row">
                    ...
                    <div style="margin-top:10px;" class="row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click"  CausesValidation="true" class="btn btn-success btn-sm"  Text="Register" />
