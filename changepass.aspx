    ...
    <div class="row cont-row">
      ...
      <div class="col-sm-4"> <asp:TextBox ID="username1" runat="server" ReadOnly="true" name="name" class="form-control input-sm"></asp:TextBox>
                        ...
                        <div  class="col-sm-2"><label>Enter Current Password:</label><span></span> </div>
                         <div class="col-sm-4"><asp:TextBox ID="passp" runat="server"  placeholder="Enter Current Password" class="form-control input-sm"></asp:TextBox>
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="passp" ErrorMessage="p/s enter your Password" BackColor="#FFCCFF"></asp:RequiredFieldValidator>
                             </div>
                        </div>
                    <div  class="row cont-row">
                 ...
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="pass1" ErrorMessage="p/s enter your Password" BackColor="#FFCCFF"></asp:RequiredFieldValidator>
                             </div>
                        </div>
                                       <div  class="row cont-row">
