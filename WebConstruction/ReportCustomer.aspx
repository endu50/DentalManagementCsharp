<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reportcustomer.aspx.cs" Inherits="DanaSolution.Reportcustomer" %>
...
<!doctype html>
                    ...
                    <div class="row nav-col">
                        <ul>
                           ...
                           <li><a href="Totalpricereport.aspx">Total Price report by date</a></li>
                            <li><a href="workedby.aspx">Report Worked By</a></li>
  ...
  <h3 style="text-align:center; background-color:beige">Customer Data Report</h3>
 ...
 <asp:Repeater ID="Repeater11" runat="server" EnableVIewState="true" OnItemCommand="Repeater1_ItemCommand"   >
    <HeaderTemplate>
        <table>
            <tr>
                                      <td><b>Search</b><asp:TextBox ID="search" TextMode="Number" runat="server" placeholder="Enter Phonenumber" ></asp:TextBox></td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Font-Size="Medium" ErrorMessage="Enter PhoneNumber in the search box" ControlToValidate="search" ForeColor="Orange"  ></asp:RequiredFieldValidator>            
                <td><asp:LinkButton ID="LinkButton2" Text="Search" CausesValidation="true" runat="server" OnClick="OnSearch" EnableVIewState="true" class="btn btn-success btn-sm" /></td>
    ...
    <ItemTemplate>
       ...
       <tr>
                               ...
                               <td>
                               <asp:LinkButton ID="lnkUpdate1" Text="Update" runat="server" CausesValidation="false" OnClick="OnUpdate" OnClientClick="return confirm('Are you sure you want to Update this event?');" EnableVIewState="true" class="btn btn-success btn-sm" />
                               </td>
...
<asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
        ...
        <div style="margin-top: 20px;">
                    <table style="width: 600px;">
                        <tr>
                            <td>
                                <asp:LinkButton ID="lbFirst1" runat="server" OnClick="lbFirst_Click" class="btn btn-success btn-sm" CausesValidation="false" BorderColor="YellowGreen">First</asp:LinkButton>
                            </td>
                            <td>
                                <asp:LinkButton ID="lbPrevious1" runat="server" OnClick="lbPrevious_Click" class="btn btn-success btn-sm" CausesValidation="false" BorderColor="YellowGreen">Previous</asp:LinkButton>
                            </td>
                            <td>
                                <asp:DataList ID="rptPaging1" runat="server"
                                    OnItemCommand="rptPaging_ItemCommand"
                                    OnItemDataBound="rptPaging_ItemDataBound" 
					RepeatDirection="Horizontal">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbPaging1" runat="server" class="btn btn-success btn-sm"
                                            CommandArgument='<%# Eval("PageIndex") %>' 
						CommandName="newPage" CausesValidation="false"
                            ...
                            <td>
                                <asp:LinkButton ID="lbNext1" runat="server" class="btn btn-success btn-sm"
			CausesValidation="false"	OnClick="lbNext_Click"  BorderColor="YellowGreen">Next</asp:LinkButton>
                            </td>
                            <td>
                                <asp:LinkButton ID="lbLast1" runat="server" class="btn btn-success btn-sm"
			CausesValidation="false"	OnClick="lbLast_Click"  BorderColor="YellowGreen">Last</asp:LinkButton>
                            </td>
                            <td>
