<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Totalpricereport.aspx.cs" Inherits="DanaSolution.Totalpricereport" %>
<!doctype html>
    <html lang="en">
  ...
  <h3 style="text-align:center; background-color:beige">Total price Report By Putting Start and End Date</h3>
 ...
 <asp:Repeater ID="Repeater11" runat="server" EnableVIewState="true" OnItemDataBound = "Repeater11_OnItemDataBound"   >
    <HeaderTemplate>
        <table>
            <tr>   
           <td> <asp:Label ID="start" runat="server" Text="Select Start Date:" Font-Bold="True"></asp:Label></td>
        <td><asp:TextBox ID="textBox1" placeholder="select date" type="date"  runat="server"></asp:TextBox> </td>   
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1"  ControlToValidate="textBox1" runat="server" ForeColor="Red" ErrorMessage="Required field Enter Start Date::"></asp:RequiredFieldValidator>
                <td><asp:Label ID="end" runat="server" Text=" Select End Date:" Font-Bold="True"></asp:Label></td>
<td><asp:TextBox ID="textBox2" placeholder="select date" type="date"  runat="server"></asp:TextBox></td>
 <asp:RequiredFieldValidator ID="RequiredFieldValidator2"  ControlToValidate="textBox2" runat="server" ForeColor="Red" ErrorMessage="Required field Enter End Date"></asp:RequiredFieldValidator>
                <td><asp:LinkButton ID="LinkButton1" Text="Search" runat="server" OnClick="OnSearchdate" EnableVIewState="true" class="btn btn-success btn-sm" /></td>
...
<asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
        ...
        <div style="margin-top: 20px;">
                    <table style="width: 600px;">
                        <tr>
                            <td>
                                <asp:LinkButton ID="lbFirst111" runat="server" OnClick="lbFirst_Click" class="btn btn-success btn-sm"  CausesValidation="false" BorderColor="YellowGreen">First</asp:LinkButton>
                            </td>
                            <td>
                                <asp:LinkButton ID="lbPrevious111" runat="server" OnClick="lbPrevious_Click" class="btn btn-success btn-sm"  CausesValidation="false" BorderColor="YellowGreen">Previous</asp:LinkButton>
                            </td>
                            <td>
