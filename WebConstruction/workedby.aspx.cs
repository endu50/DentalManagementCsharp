...
{
    public partial class workedby : System.Web.UI.Page
    {
        ...
        protected void OnSearchstaff(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string in1 = "Select Messageid,Name,Phonenumber,DateNow, price,RegisterdBy,Message from contact  where RegisterdBy =@RegisterdBy";
                ...
                SqlParameter searchstaff = new SqlParameter("@RegisterdBy", SqlDbType.VarChar,20);
                searchstaff.Value = textBox1.Text.ToString();
                cmd.Parameters.Add(searchstaff);
                ...
                // return;
                //Repeater1.DataBind();
                lbldisplay.Text = string.Format("{0:C}", count);
        ...
        protected void Repeater11_OnItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                Label RegisterdBy = (item.FindControl("RegisterdBy") as Label);
                count++;
               // lbldisplay.Text = string.Format("{0:C}", count);
               // lbldisplay.Visible = true;
            }
