 ...
 <asp:Repeater ID="Repeater11" runat="server" EnableVIewState="true" OnItemDataBound = "Repeater11_OnItemDataBound"   >
    <HeaderTemplate>
        ...
        <td><asp:TextBox ID="textBox1" placeholder="Enter UserId"   runat="server"></asp:TextBox> </td>   
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Input UserId In Search Box" ControlToValidate="textBox1" ForeColor="Orange"></asp:RequiredFieldValidator>
                <td><asp:LinkButton ID="LinkButton1" Text="Search" runat="server" CausesValidation="true" OnClick="OnSearchstaff" EnableVIewState="true" class="btn btn-success btn-sm" /></td>
