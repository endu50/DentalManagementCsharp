             ...
             <div id="navbarNav" class="nav-row d-none d-md-block container-fluid">
                <div class="container">
                    <div class="row nav-col">
                        <ul>
                            <li><a href="adminindex.aspx">Appointment Page</a></li>
...
<div class="page-nav no-margin row">
 ...
 <asp:Repeater ID="Repeater1" runat="server" EnableVIewState="true" OnItemCommand="Repeater1_ItemCommand"  >
    <HeaderTemplate>
        <table>
            <tr>
                                      <td><b>Search by PhoneNumber:</b><asp:TextBox ID="search" runat="server" TextMode="Number" placeholder="Enter Mobilenumber" ></asp:TextBox></td>
                                  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter Mobile Number first" CausesValidation="true" ForeColor="Orange" ValidationGroup="one" ControlToValidate="search"></asp:RequiredFieldValidator>
