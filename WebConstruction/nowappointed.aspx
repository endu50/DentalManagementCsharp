 <%@Page Language="C#" AutoEventWireup="true" CodeBehind="nowappointed.aspx.cs" Inherits="DanaSolution.nowappointed" %>
             ...
             <div id="navbarNav" class="nav-row d-none d-md-block container-fluid">
                <div class="container">
                    <div class="row nav-col">
                        <ul>
                            <li><a href="adminindex.aspx">Appointed Home</a></li>
...
<div class="page-nav no-margin row">
  ...
  <h3 style="text-align:center; background-color:beige">Today's Appointment Lists</h3>
 ...
 <asp:Repeater ID="Repeater1" runat="server" EnableVIewState="true" OnItemCommand="Repeater1_ItemCommand"  >
    <HeaderTemplate>
        <table>
            <tr>
                                      <td><b>Search By Date:</b><asp:TextBox ID="searchdate1" runat="server" type="date" placeholder="Enter Date" ></asp:TextBox></td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" BackColor="Orange" runat="server" ErrorMessage="Select Date from Date Picker" ControlToValidate="searchdate1"></asp:RequiredFieldValidator>
       ...
       <tr>
        ...
        <div style="margin-top: 20px;">
                    <table style="width: 600px;">
                        <tr>
                            <td>
                                <asp:LinkButton ID="lbFirst" runat="server" OnClick="lbFirst_Click" class="btn btn-success btn-sm" CausesValidation="false" BorderColor="YellowGreen">First</asp:LinkButton>
                            </td>
                            <td>
                                <asp:LinkButton ID="lbPrevious" runat="server" OnClick="lbPrevious_Click" class="btn btn-success btn-sm" CausesValidation="false" BorderColor="YellowGreen">Previous</asp:LinkButton>
                            </td>
                            <td>
