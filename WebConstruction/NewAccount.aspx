...
<!doctype html>
 ...
 <asp:Label ID="LblMsg1" runat="server" Visible="False"></asp:Label> 
        ...
        <div  class="row cont-row">
                   <div  class="col-md-2"><label>Your Name:</label><span></span></div>
                   
                   <div  class="col-md-4"> <asp:TextBox ID="txtName" runat="server" placeholder="Enter Name"></asp:TextBox>
                   </div>
                  <div  class="col-md-4">   <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
 ...
 <div  class="row cont-row">
     <div  class="col-md-2"><label>Email Address:</label><span></span> </div>
                  <div  class="col-md-4"><asp:TextBox ID="txtEmail" runat="server" placeholder="Enter Email Address"></asp:TextBox>
                        </div>
                  <div  class="col-md-4">    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
  ...
  <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
      ...
      ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
           ...
           <div  class="row cont-row">
    <div  class="col-md-2"><label>User ID:</label><span></span> </div> 
                 <div  class="col-md-4">   <asp:TextBox ID="txtUserID" runat="server" placeholder="Enter User ID"></asp:TextBox>
               </div>
                    <div  class="col-md-4"> <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
     ...
     ForeColor="#990000"  ToolTip="User ID is Required"></asp:RequiredFieldValidator>
         ...
         <div  class="row cont-row">
    <div  class="col-md-2"><label>Role:</label><span></span> </div> 
                 <div  class="col-md-4">    <asp:DropDownList ID="DropDownList1" runat="server"  OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" AutoPostBack= "true" Height="32px" Width="186px">
    ...
    <asp:ListItem Text="Standard" Value="2" />
                   ...
                   <div  class="col-md-4">  <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
     ControlToValidate="DropDownList1" ErrorMessage="Role is required"  
     ForeColor="#990000"  ToolTip="User ID is Required"></asp:RequiredFieldValidator>
  
          </div>
               </div>
                     <div  class="row cont-row">
<div  class="col-md-2"><label>Password:</label><span></span> </div> 
                   <div  class="col-md-4">  <asp:TextBox ID="txtPassword" placeholder="Enter Password" TextMode="Password" runat="server"></asp:TextBox>
                </div>
             <div  class="col-md-4">         <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
    ...
    ErrorMessage="Minimum 8 characters atleast 1 Alphabet, 1 Number and 1 Special Character" ForeColor="Red" />
                     ...
                     <div  class="row cont-row">
                        <div  class="col-md-2"><label>Confirm Password:</label><span></span> </div> 
                       <div  class="col-md-4">  <asp:TextBox ID="txtConfirmPass" runat="server" placeholder="Enter Confirm Password" TextMode="Password"></asp:TextBox>
                           </div>
                                 <div  class="col-md-4">        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
                  ...
                  <div  class="row cont-row">
           <div  class="col-md-2"><label></label><span></span> </div>
        <div  class="col-md-4">
